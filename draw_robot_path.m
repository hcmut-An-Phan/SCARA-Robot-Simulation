function draw_robot_path(handles,theta,alpha,frame,workspace,view_,path,step)

% this function is used for drawing robot with a path it go throught
...
%% Plot the Path
plot3(handles.axes1,path(1,1:step),path(2,1:step),path(3,1:step),'Color','r','LineWidth',2);
hold(handles.axes1,'on')
plot3(handles.axes1,path(1,1),path(2,1),path(3,1),'.','MarkerSize',25,'Color','b')
%%
